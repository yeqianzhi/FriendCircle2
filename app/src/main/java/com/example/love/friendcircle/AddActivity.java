    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String content = ((EditText)findViewById(R.id.editText5)).getText().toString();
                try {
                    URL url = null;
                    url = new URL("http://liyihui.free.idcfengye.com/insertcontent");
                    ...
                    if(httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK){//得到服务端的返回码是否连接成功
                        ...
                        System.out.println(rjson);
                                if( "Successful release of Friendship Circle".equals(rjson.get("state").toString())){
                                    Toast.makeText(getApplicationContext(),"添加成功！".toString() , Toast.LENGTH_SHORT).show();
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AddActivity.this, FricirActivity.class);
                startActivity(i);
//                if (Build.VERSION.SDK_INT >= 15) {
//                    StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy
//                            .Builder()
...
//                            temp.add(contents.getJSONObject(t).getString("content"));
//                            usernames.add(contents.getJSONObject(t).getString("username"));
//                        }
//                    }
//                } catch (Exception e) {
...
//                    data.put("username", usernames.get(j));
//                    data.put("content", temp.get(j));
//                    list.add(data);
//                }
//                /**3.准备适配器Adapter**/
...
//                    @Override
//                    public void onClick(View v) {
//                        Intent i = new Intent(AddActivity.this, AddActivity.class);
